<template>
  <div>
    <div class="tip">
      <div><b>示例网站说明：</b></div>
      <div>1. ©2021 此系统归 Hgcw 所属,只进行练习演示不用作任何商业</div>
      <div>资料来源
        <a href="https://www.imooc.com/?utm_term=%E6%85%95%E8%AF%BE%E7%BD%91&utm_campaign=SEM&utm_source=bdpinpai&bd_vid=10148206877722967654" target="_blank">
       慕课网
        </a>
      </div>
    </div>
